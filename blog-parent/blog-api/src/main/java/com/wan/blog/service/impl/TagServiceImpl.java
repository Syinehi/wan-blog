...
import com.wan.blog.dao.mapper.TagMapper;
import com.wan.blog.dao.pojo.Article;
import com.wan.blog.dao.pojo.Tag;
import com.wan.blog.service.TagService;
import com.wan.blog.vo.ArticleVo;
...
public class TagServiceImpl implements TagService {
    ...
    public Result hots(int limit) {
         ...
         * 2.查询根据tag_id 分组 计数，从大到小排列 取前limit个
         */
        List<Long> tagIds = tagMapper.findHotsTagIds(limit);
        if (CollectionUtils.isEmpty(tagIds)){
            return Result.success(Collections.emptyList());
        }
        //需求 tagId 和 tagName   Tag对象
